 ...
 * @param tokenContractAddress - The address of the token contract to approve
...
export const signApprovalTransaction = async (
  ...
  if (account.address === EVM_ZERO_ADDRESS)
    throw new Error(ErrorMessage.AccountAddressZero);
